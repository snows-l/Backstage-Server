...
INSERT INTO `favors` (`favors_id`, `favors_name`, `favors_money`, `favors_backMoney`, `favors_timer`, `remark`, `create_time`, `update_time`) VALUES (358, '石成方', '100', NULL, '2', NULL, '2024-04-01', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=122 DEFAULT CHARSET=utf8mb4 COMMENT='字典类型表';
...
INSERT INTO `sys_role` (`role_id`, `role_name`, `role_key`, `role_sort`, `menu_ids`, `data_scope`, `menu_check_strictly`, `dept_check_strictly`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (104, '人情薄', 'favor', 4, '2005,2000,2007', '1', 1, 1, '0', '0', '', '2024-05-31 22:25:48', '', '2024-06-04 18:03:19', '人情薄使用者的角色');
COMMIT;
...
CREATE TABLE `sys_user` (
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=148 DEFAULT CHARSET=utf8mb4 COMMENT='用户信息表';

-- ----------------------------
-- Records of sys_user
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`user_id`, `dept_id`, `user_name`, `nick_name`, `user_type`, `role`, `role_key`, `role_str`, `email`, `phonenumber`, `sex`, `avatar`, `password`, `status`, `del_flag`, `login_ip`, `login_date`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1, 103, 'admin', 'admin', '00', 1, 'admin', '超级管理员', 'admin@163.com', '15888888888', '1', '/imgs/avatars/avatar_20240618103819.png', 'TCgA10RAGrp2aB0RtUg0Bp9yRgBBfDZijSxuI/AxxmkS/mRqdlkLK0fCf+na/DCrHjviyxIUo32XDxB8k5PH9A==', '0', '0', '127.0.0.1', '2024-03-24 13:35:37', 'admin', '2024-03-24 13:35:37', '', '2024-04-23 17:23:31', '管理员');
INSERT INTO `sys_user` (`user_id`, `dept_id`, `user_name`, `nick_name`, `user_type`, `role`, `role_key`, `role_str`, `email`, `phonenumber`, `sex`, `avatar`, `password`, `status`, `del_flag`, `login_ip`, `login_date`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2, NULL, 'snows_l', '罗姗姗', '00', 1, 'admin', '超级管理员', 'snows_l@163.com', '15240861635', '1', '/imgs/avatars/avatar_20240618161747.png', 'ggfW7a6JwSUKo4n3xCH/gKf3MONAZ4r+RAaWxjuiU/YQdwh6MRzKyJjEpdc4ChMzLuZZaK1JN8An6OvTMEzk0A==', '0', '0', '', NULL, '', NULL, '', '2024-05-31 21:16:26', NULL);
INSERT INTO `sys_user` (`user_id`, `dept_id`, `user_name`, `nick_name`, `user_type`, `role`, `role_key`, `role_str`, `email`, `phonenumber`, `sex`, `avatar`, `password`, `status`, `del_flag`, `login_ip`, `login_date`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (129, NULL, 'eternals_l', 'eternals_l', '00', 2, 'common', '普通用户', '', '', '1', '', 'HXHVvyLJjNq0XaK2WfAcIIkTrJGXu70b9WoyzIVHuxMWADXy5ftfjMA40UwbYoBaJRB8AHy+Gn+Go8UpivLAiw==', '0', '0', '', NULL, '', NULL, '', '2024-04-19 11:01:14', NULL);
INSERT INTO `sys_user` (`user_id`, `dept_id`, `user_name`, `nick_name`, `user_type`, `role`, `role_key`, `role_str`, `email`, `phonenumber`, `sex`, `avatar`, `password`, `status`, `del_flag`, `login_ip`, `login_date`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (138, NULL, 'empty', '没有权限', '00', 103, '', '', '', '', '1', '', 'boL+ydafh0ZbxTFKok/cf2wR6/AMcd2b3H8c4bpMVAeSge/tMrlFluNJ6NpTXi5V/lBmBT8HAeajUlazDvoP6Q==', '0', '0', '', NULL, '', '2024-05-31 11:05:33', '', NULL, NULL);
INSERT INTO `sys_user` (`user_id`, `dept_id`, `user_name`, `nick_name`, `user_type`, `role`, `role_key`, `role_str`, `email`, `phonenumber`, `sex`, `avatar`, `password`, `status`, `del_flag`, `login_ip`, `login_date`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (147, NULL, 'lxx2', 'lxx2', '00', 104, 'favor', '', '', '', '0', '', 'C/ZWTkILLlfUeD7r2VqBM3BLFOLzlOh5rZ39K1MBQl8lvkEFMb2Mcdlnhy5bSf4PRO3lbmC3gnFZ20ELm6uNdQ==', '0', '0', '', NULL, '', '2024-06-04 16:44:35', '', NULL, NULL);
COMMIT;
...
INSERT INTO `wages` (`id`, `title`, `money`, `date`, `pic`, `source`, `del_flag`, `create_time`, `remark`) VALUES (19, '2022/03 工资明细', '451.65', '2022-03-15', '/imgs/wages/wages_202203_01_20240617233236.jpeg', '1', 0, '2024-06-17 23:33:10.524', '2022/03 工资明细（重庆深能）');
...
INSERT INTO `wages` (`id`, `title`, `money`, `date`, `pic`, `source`, `del_flag`, `create_time`, `remark`) VALUES (35, '2022 年终奖', '10752.38', '2023-06-15', '/imgs/wages/wages_2023-å¹´ç»å¥_20240617234312.jpeg', '2', 0, '2024-06-17 23:43:55.409', '2022 年终奖（云诺）');
INSERT INTO `wages` (`id`, `title`, `money`, `date`, `pic`, `source`, `del_flag`, `create_time`, `remark`) VALUES (36, '2023 离职补偿金', '36958.51', '2023-07-15', '/imgs/wages/wages_2023_äºè¯º_ç¦»èè¡¥å¿é_20240617234409.jpeg', '2', 0, '2024-06-17 23:44:54.328', '2023 离职补偿金 （云诺）');
...
INSERT INTO `wages` (`id`, `title`, `money`, `date`, `pic`, `source`, `del_flag`, `create_time`, `remark`) VALUES (44, '2024/05 工资明细', '13858.29', '2024-05-15', '/imgs/wages/wages_202405_20240617235455.jpeg', '3', 0, '2024-06-17 23:55:11.245', '2024/05 工资明细');
COMMIT;
