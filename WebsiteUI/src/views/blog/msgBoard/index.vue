 ...
 * @LastEditTime: 2024-09-02 19:28:02
...
<template>
  <div class="musics-container-warp">
    ...
    <EditDialog ref="editDialogRef" :refreshCallBack="getMsgBoardListFn" :is-mobile="state.isMobile" />
  </div>
</template>
...
const columns = [
  { id: 0, label: 'ID', width: '120px', prop: 'id', align: 'center' },
